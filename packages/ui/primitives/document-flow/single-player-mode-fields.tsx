  ...
  return (
    <SinglePlayerModeFieldCardContainer field={field}>
      {insertedBase64Signature ? (
        ...
        <button
          onClick={() => onClick?.()}
          className="group-hover:text-primary text-muted absolute inset-0 h-full w-full duration-200"
        >
          Signature
        </button>
      )}
  ...
  return (
    <SinglePlayerModeFieldCardContainer field={field}>
      {field.inserted ? (
        ...
        <button
          onClick={() => onClick?.()}
          className="group-hover:text-primary text-muted absolute inset-0 h-full w-full text-lg duration-200"
        >
          {match(field.type)
