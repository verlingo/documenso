...
export const UserProfileTimur = ({ className, rows = 2 }: UserProfileTimurProps) => {
  ...
  return (
    ...
    >
      <div className="border-border bg-background text-muted inline-block max-w-full truncate rounded-md border px-2.5 py-1.5 text-sm">
      ...
      <div className="mt-6">
        ...
        <p className="text-muted mt-4 max-w-[40ch] text-center text-sm">Hey I’m Timur</p>

        <p className="text-muted mt-1 max-w-[40ch] text-center text-sm">
      ...
      <div className="mt-8 w-full">
        <div className="dark:divide-foreground/30 dark:border-foreground/30 divide-y-2 divide-neutral-200 overflow-hidden rounded-lg border-2 border-neutral-200">
          <div className="text-muted dark:bg-foreground/20 bg-neutral-50 p-4 font-medium">
            Documents
          </div>
            ...
            .map((_, index) => (
              ...
              >
                <div className="flex items-center gap-x-2">
                  <File className="text-muted/80 h-8 w-8" strokeWidth={1.5} />
